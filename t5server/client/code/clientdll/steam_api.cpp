...
extern "C"
{
	...
	__declspec(dllexport) bool __cdecl SteamAPI_Init()
	{
		...
		strcpy((char*)0xA66F88, licenseKeyDvar->current.string);
		...
		*/
		...
		//Com_Error(1, "License: %s", licenseKey->current.string);
		...
		*/
		if (result->result != AuthenticateResultOK)
		{
			...
			case AuthenticateResultBadDetails:
				Com_Error(1, "Could not register to NP server at " MASTER_SERVER " -- bad details.\r\nRegister a license over at: http://repziw4.de/license\r\nLicense: %s", licenseKey);
				break;
			case AuthenticateResultServiceUnavailable:
				Com_Error(1, "Could not register to NP server at " MASTER_SERVER " -- service unavailable.\r\nCheck your license over at: http://repziw4.de/license\r\nLicense: %s", licenseKey);
				break;
			case AuthenticateResultBanned:
				Com_Error(1, "Could not register to NP server at " MASTER_SERVER " -- banned.\r\nCheck your license over at: http://repziw4.de/license\r\nLicense: %s", licenseKey);
				break;
			case AuthenticateResultUnknown:
				Com_Error(1, "Could not register to NP server at " MASTER_SERVER " -- unknown error.\r\nCheck your license over at: http://repziw4.de/license\r\nLicense: %s", licenseKey);
				break;
			}
		}
